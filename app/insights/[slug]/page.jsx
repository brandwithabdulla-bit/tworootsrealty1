...
import {getArticles, getArticleBySlug} from '@/lib/sanity-data';
...
export async function generateMetadata({params}){
  ...
  return p?pageMetadata(p.title,p.summary,`/insights/${slug}`):{};
}
